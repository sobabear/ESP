...
// HT1621 wiring
const int DISPLAY_CS_PIN = 25;
const int DISPLAY_WR_PIN = 14;
const int DISPLAY_DATA_PIN = 27;
const int DISPLAY_LED_PIN = 26; 
...
void setup_display() {
  lcd.begin(DISPLAY_CS_PIN, DISPLAY_WR_PIN, DISPLAY_DATA_PIN, DISPLAY_LED_PIN);
  lcd.noBacklight();
  lcd.clear();
}
