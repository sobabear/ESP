...
void write_firebase(int weight) {
  Firebase.RTDB.setTimestamp(&firebaseData, (mRef + "/timestampEx2").c_str());
  Firebase.setTimestamp(firebaseData, mRef + "/timestampEx");
  // Firebase.pushTimestamp(firebaseData, mRef + "/timestampEx2");
  int time = firebaseData.intData();
